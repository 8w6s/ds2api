...
func TestLoadDotEnvLoadsWorkingDirectoryFileWithoutOverridingExistingEnv(t *testing.T) {
	...
	const newKey = "NEUTRON_TEST_DOTENV_NEW"
	const keepKey = "NEUTRON_TEST_DOTENV_KEEP"
	const quotedKey = "NEUTRON_TEST_DOTENV_QUOTED"

	unsetEnv(t, newKey)
	unsetEnv(t, quotedKey)
	t.Setenv(keepKey, "from-env")

	content := "NEUTRON_TEST_DOTENV_NEW=from-file\n" +
		"NEUTRON_TEST_DOTENV_KEEP=from-file\n" +
		"NEUTRON_TEST_DOTENV_QUOTED=\"line1\\nline2\"\n"
...
func TestLoadDotEnvStripsInlineCommentsFromUnquotedValues(t *testing.T) {
	...
	const plainKey = "NEUTRON_TEST_DOTENV_PLAIN"
	const hashKey = "NEUTRON_TEST_DOTENV_HASH"
	const quotedKey = "NEUTRON_TEST_DOTENV_QUOTED_COMMENT"
	const exportKey = "NEUTRON_TEST_DOTENV_EXPORT"
