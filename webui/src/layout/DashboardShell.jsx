                        ...
                        <div className="bg-background rounded-lg p-3 border border-border shadow-sm">
                            ...
                            {versionInfo?.has_update && (
                                <a
                                    ...
                                    href={versionInfo?.release_url || 'https://github.com/NeutronAPI Team/neutronapi/releases/latest'}
                                    target="_blank"
                                    rel="noreferrer"
                                >
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                <header className="lg:hidden h-14 flex items-center justify-between px-4 border-b border-border bg-card">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-sm">NeutronAPI</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <LanguageToggle />
                        <button
                ...
                <div className="flex-1 overflow-auto bg-background p-4 lg:p-10">
                    <div className="max-w-6xl mx-auto space-y-4 lg:space-y-6">
                        ...
                        <div className="animate-in fade-in duration-500">
                            <Suspense fallback={<TabLoadingFallback label={activeNavItem?.label || 'NeutronAPI'} />}>
                                {renderTab()}
                            </Suspense>
                        </div>
                    </div>
